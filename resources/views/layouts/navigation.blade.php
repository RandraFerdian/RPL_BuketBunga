        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- ====================================================== --}}
                    {{-- ==== KODE INI YANG MENENTUKAN LINK NAVIGASI ==== --}}
                    {{-- ====================================================== --}}
                    ...
                    @else
                        ...
                        {{-- Tambahkan link riwayat pesanan pengguna di sini nanti --}}
                    @endif
                    {{-- ====================================================== --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('pesanan.index')" :active="request()->routeIs('pesanan.index')">{{ __('Manajemen Pesanan') }}</x-responsive-nav-link>
                <x-responsive-nav-link :href="route('produk.index')" :active="request()->routeIs('produk.index')">{{ __('Manajemen Produk') }}</x-responsive-nav-link>
            @else
